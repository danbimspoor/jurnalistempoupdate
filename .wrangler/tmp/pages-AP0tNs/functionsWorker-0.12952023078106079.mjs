...
var onRequestPost = /* @__PURE__ */ __name(async (context2) => {
  try {
    const { username, password } = await context2.request.json();
...
// ../.wrangler/tmp/pages-AP0tNs/functionsRoutes-0.06408456498958048.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-BtWgKB/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-BtWgKB/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.12952023078106079.mjs.map
